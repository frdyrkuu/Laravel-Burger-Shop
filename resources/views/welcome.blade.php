...
<body class="body antialiased dark:bg-dots-lighter dark:bg-gray-900">
    ...
    <main class="max-w-7xl mx-auto ">
        ...
        <section class="flex flex-col-reverse justify-center sm:flex-row p-6 items-center gap-4 mb-12">
            <article class="sm:w-1/2 ">
                ...
                <br>
                <h2 class="text-4xl font-semibold sm:text-4xl text-orange-500 dark:text-white text-center sm:text-left">
        ...
        <section id="food" class="p-6 my-1 justify-center items-center">
            ...
            <ul class="list-none mx-auto my-12 flex flex-col sm:flex-row items-center gap-8">
                ...
                <!-- CARD 1 -->
                <li
                    class=" w-full sm:w-5/6 flex flex-col items-center bg-white py-6 rounded-3xl shadow-2xl hover:animate-floating">
        ...
        <section id="about" class="p-6 my-12 justify-center items-center">
            ...
            <!-- component -->
            <div class="container mx-auto mb-32 sm:my-10 sm:bg-white sm:shadow-lg sm:rounded-2xl">
                <div class="grid grid-cols-1 md:grid-cols-2 h-screen">
                    ...
                    <div class="flex bg-white shadow-xl rounded-lg sm:bg-transparent sm:shadow-none sm:rounded-none">
                        <div class="mb-auto mt-auto max-w-lg">
                            <h1 class="text-5xl uppercase text-orange-500 font-bold font-['Poppins'] text-center mt-5">
                                Burger Dungeon
                            </h1>
                            <p class="font-semilight text-orange-400 mb-5 font-['Poppins'] text-center text-3xl">
                                Welcome to Burger Dungeon, the ultimate
                                destination for burger
                                enthusiasts!
                            </p>
                            <p
                                class="font-['Poppins'] text-sm text-center sm:text-justify sm:text-xl px-2 text-gray-600">
